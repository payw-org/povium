		...
		<section class="post-section">
			...
			<div class="post-scroll-area">
				...
				<div class="post-container">
					...
					<div class="post-item">
						<div class="image-placeholder">
							<img class="image" src="/assets/images/sets/5.jpg" alt="">
						</div>
						<div class="post-content">
							<h1 class="post-title">Group of employees calls for end to Microsoft's $480M HoloLens military contract</h1>
						</div>
					...
					<div class="post-item">
						<div class="image-placeholder">
							<img class="image" src="/assets/images/sets/6.jpg" alt="">
						</div>
						<div class="post-content">
							<h1 class="post-title">Group of employees calls for end to Microsoft's $480M HoloLens military contract</h1>
						</div>
					...
					<div class="post-item">
						<div class="image-placeholder">
							<img class="image" src="/assets/images/post-test-img-1.jpg" alt="">
						</div>
						<div class="post-content">
							<h1 class="post-title">Group of employees calls for end to Microsoft's $480M HoloLens military contract</h1>
						</div>
					...
					<div class="post-item">
						<div class="image-placeholder">
							<img class="image" src="/assets/images/post-test-img-2.jpg" alt="">
						</div>
						<div class="post-content">
							<h1 class="post-title">Group of employees calls for end to Microsoft's $480M HoloLens military contract</h1>
						</div>
