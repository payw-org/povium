		...
		<aside class="mobile-menu">
			<nav class="mm-nav">
				<ol>
					...
					<li class="gn-m-item my-page">
						<a class="gn-m-link" href="/">{{$global_nav['user_name']}}</a>
					</li>
					<li class="gn-m-item my-page">
						<a class="gn-m-link full-load" href="/logout">로그아웃</a>
					</li>
					
					@else

					<li class="gn-m-item login">
						<a class="gn-m-link" href="/login">로그인</a>
					</li>

					<li class="gn-m-item register">
